...
while not GeomConverged and Opt_Freq_iterations < 10:
    ...
    optimized_energy_xyz = psi4.optimize('pbe0', molecule=mol)     # Run the geometry optimization
    ...
    freq_energy, wfn = psi4.frequency('pbe0', molecule=mol, return_wfn=True)   # Run the frequency calculation
