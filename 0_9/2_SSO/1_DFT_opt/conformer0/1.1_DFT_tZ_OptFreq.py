...
geom_directory = "/p/home/jorgecga/SwitchesFor-aRuCl3/AfterMay8_2026/0_9/2_SSO/1_DFT_opt/conformer0/"
geom_file = "mol_afterPBE0-D4_Opt0.xyz"
...
while not GeomConverged and Opt_Freq_iterations < 5:
    ...
    DFT_OptGeom_file = f'mol_after_M062X_Opt{Opt_Freq_iterations}.xyz'
    ...
    if not imaginary_freqs:
        ...
        IM_file = f"i_mode_displacements_M062X_{Opt_Freq_iterations}.txt"  # Define the filename
