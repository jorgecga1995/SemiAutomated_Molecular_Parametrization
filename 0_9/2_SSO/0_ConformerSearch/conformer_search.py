...
input_file = '/p/home/jorgecga/SwitchesFor-aRuCl3/AfterApr29_2026/SSB/stiff-stilbene.mol2' # Or 'pyri.pdb', etc.
...
for iso in isomers:
    ...
    iso_cids = AllChem.EmbedMultipleConfs(iso, numConfs=10, params=AllChem.ETKDGv2())
