...
geom_directory = "/p/home/jorgecga/SwitchesFor-aRuCl3/AfterApr29_2026/SSB/0_ConformerSearch/unique_conformers_xyz/"
...
while not GeomConverged and Opt_Freq_iterations < 10:
    ...
    optimized_energy_xyz = psi4.optimize('pbe0-d3bj', molecule=mol)     # Run the geometry optimization
    ...
    freq_energy, wfn = psi4.frequency('pbe0-d3bj', molecule=mol, return_wfn=True)   # Run the frequency calculation
