...
geom_directory = "/p/home/jorgecga/SwitchesFor-aRuCl3/AfterMay8_2026/0_9/3_HMT/1_DFT_opt/conformer0/"
geom_file = "0.9mol_afterB97-3c_Opt0.xyz" 
...
while not GeomConverged and Opt_Freq_iterations < 10:
    ...
    DFT_OptGeom_file = f'1.0_mol_afterPBE0-D3_Opt{Opt_Freq_iterations}.xyz'
    ...
    if not imaginary_freqs:
        ...
        IM_file = f"1.0_imaginary_mode_displacement_atPBE0-D3_{Opt_Freq_iterations}.txt"  # Define the filename
