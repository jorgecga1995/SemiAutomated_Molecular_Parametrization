...
geom_file = "unique_conformer_5.xyz" 
...
while not GeomConverged and Opt_Freq_iterations < 10:
    ...
    DFT_OptGeom_file = f'0.9mol_afterB97-3c_Opt{Opt_Freq_iterations}.xyz'
    ...
    if not imaginary_freqs:
        ...
        IM_file = f"0.9imaginary_mode_displacement_atB97-3c_{Opt_Freq_iterations}.txt"  # Define the filename
